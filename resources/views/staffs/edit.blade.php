                        ...
                        <form method="post" action="{{ route('staffs.update', $staff->id) }}">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="staff_surname" value="{{ $staff->staff_surname }}">
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input type="email" class="form-control" name="staff_email" value="{{ $staff->staff_email }}">
                            </div>

                            <div class="form-group">
                                <label for="phone">Téléphone</label>
                                <input type="text" class="form-control" name="staff_phone" value="{{ $staff->staff_phone }}">
                            </div>
                            
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="adress">Ville</label>
                                    <input type="text" class="form-control" name="staff_adress" value="{{ $staff->staff_adress }}">
                                </div>

                                <div class="form-group col-md-2">
                                    <label for="code">Code</label>
                                    <input type="text" class="form-control" name="staff_code" value="{{ $staff->staff_code }}">
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="inputState">Utilisateur</label>
                                <select id="inputState" class="form-control" name="user_id" value="{{ $staff->user_id }}">
