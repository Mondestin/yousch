...
@section('content-header')
     <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-md-6">
          <h1 class="text-black">Modifier les informations du staff</h1>
          </div>
        </div>
      </div>
       ...
       <!-- Left side elements -->
            ...
            <div class="row" style="margin-left: 35%;">
              <div class="col-sm-4 col-sm-offset-1">
                <div class="picture-container">
                  <div class="picture">
                      <img src="{{asset('uploads/staffs')}}/{{$staff->avatar}}" class="picture-src" id="wizardPicturePreview" title=""/>
        ...
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <span class="red">*</span>
            <input type="text" class="form-control @error('staff_surname') is-invalid @enderror" name="staff_surname"  value="{{ $staff->staff_surname }}">
          </div>
          <div class="form-group col-md-6">
        ...
        <div class="row">
          <div class="form-group col-md-5">
            ...
            <span class="red">*</span>
            <input type="date" class="form-control @error('staff_dob') is-invalid @enderror" name="staff_dob" value="{{ $staff->staff_dob }}">
          </div>
          <div class="form-group col-md-3">
            <label for="staff_sexe">Sexe</label>
            <span class="red">*</span>
            <select name="staff_sexe" class="form-control @error('staff_sexe') is-invalid @enderror">
              <option value="{{ $staff->staff_sexe }}" hidden>{{ $staff->staff_sexe }}</option>
          ...
          <select name="staff_country" class="form-control @error('staff_country') is-invalid @enderror">
             <option value="{{ $staff->staff_country }}">{{ $staff->staff_country }}</option>
        ...
        <div class="row">
          <div class="form-group col-md-12">
            ...
            <span class="red">*</span>
            <input type="text" class="form-control @error('staff_pob') is-invalid @enderror" name="staff_pob"  value="{{ $staff->staff_pob }}">
          </div>
        </div>
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <span class="red">*</span>
            <input type="text" class="form-control @error('staff_adress') is-invalid @enderror" name="staff_adress" value="{{ $staff->staff_adress }}">
          </div>
          <div class="form-group col-md-3">
            <label for="Name">Code Postal</label>
            <span class="red">*</span>
            <input type="number" class="form-control @error('staff_postal') is-invalid @enderror" name="staff_postal" value="{{ $staff->staff_postal }}">
          </div>
          <div class="form-group col-md-3">
            <label for="Name">Ville</label>
            <span class="red">*</span>
            <input type="text" class="form-control @error('staff_ville') is-invalid @enderror" name="staff_ville" value="{{ $staff->staff_ville }}">
          </div>
        </div>
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <span class="red">*</span>
            <input type="email" class="form-control  @error('staff_email') is-invalid @enderror" name="staff_email"  value="{{ $staff->staff_email }}">
            @error('staff_email')
            ...
            <div class="form-group col-md-6">
              ...
              <span class="red">*</span>
              <input type="number" class="form-control @error('staff_phone') is-invalid @enderror" name="staff_phone"  value="{{ $staff->staff_phone }}">
            </div>
        </div>  
